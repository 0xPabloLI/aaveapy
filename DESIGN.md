...
以下路径保留为重定向，正文已并入 `DESIGN-SYSTEM-REFERENCE.md`：[ui-interaction-patterns.md](docs/design/ui-interaction-patterns.md)、[toggle-switch-specification.md](docs/design/toggle-switch-specification.md)。
