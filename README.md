...
|---|---:|---|---|
| `coreSnapshotApi` | 2m | `/markets` `/markets/list` `/rate-inputs` snapshot | Same backend snapshot family; 2m UI cache reduces redundant refetch while staying within acceptable freshness. |
