...
|---|---:|---|---|
| `coreSnapshotApi` | 5m | `/markets` `/markets/stats` `/markets/list` `/rate-inputs` snapshot | Same backend snapshot family; 5m UI cache reduces redundant refetch while staying within acceptable freshness. |
