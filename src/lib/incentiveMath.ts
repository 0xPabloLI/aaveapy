...
export function computePositionCapEligibility(positionUsd: number, capUsd: number): PositionCapEligibility {
...
export function applyPositionCap(nominalAprPercent: number, positionUsd: number, capUsd: number): PositionCapResult {
...
export function computeBudgetRemainingDays(remainingBudget: number, dailyReward: number, calendarDays: number): number {
