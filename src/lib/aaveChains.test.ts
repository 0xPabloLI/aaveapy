...
import { AAVE_V3_CHAIN_IDS, AAVE_V4_CHAIN_IDS, isAaveMainnetChain, getAaveProtocolVersion } from './aaveChains';

describe('aaveChains', () => {
  describe('AAVE_V3_CHAIN_IDS', () => {
    it('contains all 21 V3 mainnet chain IDs', () => {
      const expected = [
        1, 42161, 43114, 56, 8453, 42220, 100, 59144, 5000, 1088, 10, 137, 534352, 1868, 146, 196, 324, 57073, 4326,
        9745, 143,
      ];
