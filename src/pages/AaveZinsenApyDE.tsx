...
const content: RatesPageContent = {
  ...
  calculator: {
    ...
    intro:
      'Betrag in Euro eingeben, Stablecoin-Reserve auswählen — der Rechner nutzt den aktuellen Einlagenzins von Aave V3 und zeigt den Bruttoertrag pro Jahr, Monat und Tag.',
    numberLocale: 'de-DE',
    currency: 'EUR',
    defaultAmount: 10000,
    amountLabel: 'Einlage (€)',
    ...
    disclaimer:
      'Schätzung bei konstantem Zins: Der APY ändert sich laufend. Der Ertrag entsteht in US-Dollar, Wechselkurs, Netzwerkgebühren und Steuern sind nicht berücksichtigt. Keine Anlageberatung.',
  },
  ogLocale: 'de_DE',
