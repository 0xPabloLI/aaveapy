...
const content: RatesPageContent = {
  ...
  calculator: {
    id: "calcolatore",
    h2: "Calcolatore di rendimento in euro",
    intro: "Inserisci un importo in euro e scegli una riserva in stablecoin: il calcolatore applica il tasso di deposito live di Aave V3 e mostra il guadagno lordo all’anno, al mese e al giorno.",
    numberLocale: "it-IT",
    currency: "EUR",
    defaultAmount: 10000,
    amountLabel: "Importo depositato (€)",
    reserveLabel: "Riserva (tasso live)",
    apyLabel: "APY di deposito",
    perYear: "All’anno",
    perMonth: "Al mese",
    perDay: "Al giorno",
    usdEquivalentLabel: "Equivalente in dollari:",
    loading: "Caricamento dei tassi live…",
    error: "Tassi non disponibili al momento. Riprova tra qualche minuto.",
    disclaimer: "Stima a tasso costante: l’APY di Aave cambia in continuazione. Il rendimento matura in dollari, quindi cambio, commissioni di rete e fiscalità non sono inclusi. Non è consulenza finanziaria.",
  },
  ogLocale: 'it_IT',
