...
const content: RatesPageContent = {
  ...
  calculator: {
    id: "calculadora",
    h2: "Calculadora de rendimiento en euros",
    intro: "Introduce un importe en euros y elige una reserva de stablecoin: la calculadora aplica la tasa de depósito en vivo de Aave V3 y muestra la ganancia bruta al año, al mes y al día.",
    numberLocale: "es-ES",
    currency: "EUR",
    defaultAmount: 10000,
    amountLabel: "Importe depositado (€)",
    reserveLabel: "Reserva (tasa en vivo)",
    apyLabel: "APY de depósito",
    perYear: "Al año",
    perMonth: "Al mes",
    perDay: "Al día",
    usdEquivalentLabel: "Equivale en dólares:",
    loading: "Cargando tasas en vivo…",
    error: "Tasas no disponibles ahora mismo. Inténtalo de nuevo en unos minutos.",
    disclaimer: "Estimación con tasa constante: el APY de Aave cambia continuamente. El rendimiento se genera en dólares, así que no incluye el tipo de cambio, las comisiones de red ni los impuestos. No es asesoramiento financiero.",
  },
  ogLocale: 'es_ES',
