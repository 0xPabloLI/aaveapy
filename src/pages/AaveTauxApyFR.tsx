...
const content: RatesPageContent = {
  ...
  calculator: {
    ...
    intro: "Saisissez un montant en euros et choisissez une réserve stablecoin : le calculateur applique le taux de dépôt en direct d'Aave V3 et affiche le gain brut par an, par mois et par jour.",
    numberLocale: "fr-FR",
    currency: "EUR",
    defaultAmount: 10000,
    ...
    disclaimer: "Estimation à taux constant : l'APY d'Aave varie à chaque bloc. Le rendement est libellé en dollars, donc le change EUR/USD, les frais de réseau et la fiscalité ne sont pas inclus. Ceci n'est pas un conseil en investissement.",
  },
  ogLocale: 'fr_FR',
