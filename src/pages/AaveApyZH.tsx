...
const content: RatesPageContent = {
  ...
  calculator: {
    id: "jisuanqi",
    h2: "新台幣收益試算工具",
    intro: "輸入新台幣金額並選擇一個穩定幣儲備池，試算工具會套用 Aave V3 的即時存款 APY，顯示每年、每月與每日的概估利息。",
    numberLocale: "zh-TW",
    currency: "TWD",
    defaultAmount: 300000,
    amountLabel: "存入金額（NT$）",
    reserveLabel: "儲備池（即時利率）",
    apyLabel: "存款 APY",
    perYear: "每年",
    perMonth: "每月",
    perDay: "每日",
    usdEquivalentLabel: "約等於美元：",
    loading: "正在載入即時利率…",
    error: "目前無法取得利率，請稍後再試。",
    disclaimer: "此為利率不變前提下的估算，Aave 的 APY 隨時變動。利息以美元計價，未計入匯率、鏈上手續費與稅負，並非投資建議。",
  },
  ogLocale: 'zh_TW',
