...
const content: RatesPageContent = {
  ...
  calculator: {
    ...
    intro:
      'Masukkan nominal dalam rupiah dan pilih reserve stablecoin: kalkulator memakai APY deposit Aave V3 terkini dan menampilkan estimasi hasil per tahun, per bulan, dan per hari.',
    numberLocale: 'id-ID',
    currency: 'IDR',
    ...
    disclaimer:
      'Perhitungan mengasumsikan tarif tetap, padahal APY Aave berubah terus. Imbal hasil diterima dalam dolar AS, jadi kurs rupiah, biaya jaringan, dan pajak belum diperhitungkan. Ini bukan saran investasi.',
  },
  ogLocale: 'id_ID',
