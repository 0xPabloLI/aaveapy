...
const content: RatesPageContent = {
  ...
  calculator: {
    id: "kalkulator",
    h2: "Kalkulator imbal hasil dalam rupiah",
    intro: "Masukkan nominal dalam rupiah dan pilih reserve stablecoin: kalkulator memakai APY deposit Aave V3 terkini dan menampilkan estimasi hasil per tahun, per bulan, dan per hari.",
    numberLocale: "id-ID",
    currency: "IDR",
    defaultAmount: 50000000,
    amountLabel: "Nominal deposit (Rp)",
    reserveLabel: "Reserve (tarif terkini)",
    apyLabel: "APY deposit",
    perYear: "Per tahun",
    perMonth: "Per bulan",
    perDay: "Per hari",
    usdEquivalentLabel: "Setara dalam dolar AS:",
    loading: "Memuat tarif terkini…",
    error: "Tarif belum tersedia. Coba lagi beberapa saat lagi.",
    disclaimer: "Perhitungan mengasumsikan tarif tetap, padahal APY Aave berubah terus. Imbal hasil diterima dalam dolar AS, jadi kurs rupiah, biaya jaringan, dan pajak belum diperhitungkan. Ini bukan saran investasi.",
  },
  ogLocale: 'id_ID',
