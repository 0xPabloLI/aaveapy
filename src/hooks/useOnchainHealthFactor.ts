 ...
 */
export function extractPoolTargets(entries: PortfolioReserveEntry[], reserves: ReserveWithSpread[]): PoolTargets {
...
type BigintTupleResult = { status: 'success'; result: readonly bigint[] } | { status: 'failure'; result?: undefined };
