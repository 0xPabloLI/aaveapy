...
import { HEADER_CONTROL_FOCUS_RING_CLASS, HEADER_CONTROL_ICON_BUTTON_CLASS } from '@/lib/headerControlStyles';
...
describe('WatchAddressInput', () => {
  ...
  it('shows failure reason and supports re-import', async () => {
    ...
    expect(reimportBtn).toHaveAttribute(
      'title',
      'Retry importing the previously entered address after a connection failure',
    );
