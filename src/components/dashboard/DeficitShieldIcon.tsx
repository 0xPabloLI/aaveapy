...
export default function DeficitShieldIcon({ className, ratio }: DeficitShieldIconProps) {
  ...
  const tinyBoost = normalizedRatio <= 0.05 ? Math.pow(normalizedRatio / 0.05, 0.45) * 0.24 : 0.24;
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="M35 33 L44 42 L44 66"
        stroke="currentColor"
        strokeOpacity={crackOpacity}
        strokeWidth={crackStrokeWidth}
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <path
      ...
      <path
        d="M58 31 L63 37"
        stroke="currentColor"
        strokeOpacity={stage1Opacity}
        strokeWidth={crackStrokeWidth * 0.68}
        strokeLinecap="round"
      />
      <path
        d="M60 56 L67 59"
        stroke="currentColor"
        strokeOpacity={stage2Opacity}
        strokeWidth={crackStrokeWidth * 0.72}
        strokeLinecap="round"
      />
      <path
        d="M41 58 L36 63"
        stroke="currentColor"
        strokeOpacity={stage2Opacity * 0.9}
        strokeWidth={crackStrokeWidth * 0.7}
        strokeLinecap="round"
      />
      <path
        d="M47 27 L52 31"
        stroke="currentColor"
        strokeOpacity={stage3Opacity}
        strokeWidth={crackStrokeWidth * 0.62}
        strokeLinecap="round"
      />
      <path
        d="M66 45 L71 48"
        stroke="currentColor"
        strokeOpacity={stage3Opacity * 0.9}
        strokeWidth={crackStrokeWidth * 0.58}
        strokeLinecap="round"
      />
    </svg>
  );
