...
const MobileReserveCard = memo(({
  ...
  return (
    ...
    >
      ...
      {/* Size section: tap opens mobile bottom sheet (same pattern as IncentiveTooltip), not floating popover */}
      <div
      ...
      {/* Mobile bottom sheet: backdrop + sheet with title + X, content left-aligned with title (px-[var(--ds-space-4)]) */}
      {capSheet !== null && (
        <>
          <div
      ...
      <div className="mt-[var(--ds-space-3)] border-t border-border/60 pt-[var(--ds-space-2)]">
        <button
          ...
          className="relative inline-flex w-full items-center justify-center rounded-lg border border-border/70 bg-background px-[var(--ds-space-2)] py-[var(--ds-space-1-5)] ds-text-12 text-muted-foreground transition-colors hover:bg-muted/40"
        >
