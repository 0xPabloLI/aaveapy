...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: 'Data refreshes automatically every ~30 seconds. The freshness dot on the floating refresh button shows green (fresh), yellow (slightly stale), or red (stale). You can also pull down or click the refresh button to force an update.',
  },
  {
...
const FaqSection = memo(function FaqSection() {
  return (
    <section className="border-t border-border/50 pt-[var(--ds-space-6)] pb-[var(--ds-space-2)]">
