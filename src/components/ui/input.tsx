...
export type InputProps = React.ComponentProps<"input"> & {
  ...
  /** Disable DS surface classes for custom inline input shells. */
  disableSurface?: boolean;
};

const Input = React.forwardRef<HTMLInputElement, InputProps>(
  ({ className, type, value, surfaceVariant = "neutral", disableSurface = false, ...props }, ref) => {
    const hasValue =
    ...
    return (
      <input
        ...
        className={cn(
          ...
          className,
          disableSurface ? null : cnDsInputSurface(hasValue, surfaceVariant),
        )}
        ref={ref}
        value={value}
        {...props}
