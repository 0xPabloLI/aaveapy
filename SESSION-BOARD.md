...
| codex-0415b | Codex | 修复 explorer links + 增加真实浏览器校验并更新文档提交 | src/lib/poolExplorerLinks.ts, src/lib/poolExplorerLinks.test.ts, scripts/test-explorer-links.ts, scripts/verify-explorer-links.ts, scripts/, docs/pool-explorer-links.md, docs/explorer-links-verification-report.md, docs/explorer-links-sync-architecture.md, .github/workflows/, SESSION-BOARD.md | done | 2026-04-15T20:35:00Z | 已完成并提交 |
