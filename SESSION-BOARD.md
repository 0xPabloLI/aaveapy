...
| droid-0421a | Droid | 修复 AssetActionMenu 上翻时的水平/垂直偏移 + 测试 | src/components/dashboard/AssetActionMenu.tsx, src/components/dashboard/assetActionMenuPosition.ts, src/components/dashboard/assetActionMenuPosition.test.ts, scripts/verify-asset-action-menu-position.mjs, SESSION-BOARD.md | done | 2026-04-21T00:00:00Z | 中心锚点 + offsetHeight 实测校正；9 单元测试 + Playwright 实机校验通过（flip-above gap 50px→6px） |
